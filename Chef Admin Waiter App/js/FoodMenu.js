            ...
            var cart10 = '';
                  ...
                  for(var i =0 ; i<dataType.length ; i++){
                        ...
                        if(amountต้มยำกุ้ง != 0){
                            ...
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >ต้มยำกุ้ง: <input type="text" id="amountTotal1" value="'+amountต้มยำกุ้ง+'" disabled></input> จๅน</div><input id="detail1" value="'+detail1+'" disabled></input><input id="cart1" value="'+cart1+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send1()">comfirm</ons-button></ons-list-item></ons-card>');

                         }
                        if(amountต้มเส้นตีนไก่ != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >ต้มเส้นตีนไก่: <input type="text" id="amountTotal3" value="'+amountต้มเส้นตีนไก่+'" disabled></input> จๅน</div><input id = "detail3" value="'+detail3+'" disabled></input><input id="cart3" value="'+cart3+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send3()">comfirm</ons-button></ons-list-item></ons-card>');
                         }
                          if(amountผัดแกงเขียวหวานปลาแซลมอน != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >ผัดแกงเขียวหวานปลาแซลมอน: <input id="amountTotal4" value="'+amountผัดแกงเขียวหวานปลาแซลมอน+'" disabled></input> จๅน</div><input id="detail4" value="'+detail4+'" disabled></input><input id="cart4" value="'+cart4+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send4()">comfirm</ons-button></ons-list-item></ons-card>');  
                         }
                         if(amountผัดผักโสภณลูกชิ้นกุ้ง != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >ผัดผักโสภณลูกชิ้นกุ้ง: <input id="amountTotal5" value="'+amountผัดผักโสภณลูกชิ้นกุ้ง+'" disabled> </input> จๅน</div><input id="detail5" value="'+detail5+'" disabled></input><input id="cart5" value="'+cart5+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send5()">comfirm</ons-button></ons-list-item></ons-card>');
                         }
                          if(amountฉู่ฉี่ปลาเนื้ออ่อน != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >ฉู่ฉี่ปลาเนื้ออ่อน: <input id="amountTotal6" value="'+amountฉู่ฉี่ปลาเนื้ออ่อน+'" disabled></input> จๅน</div><input id="detail6" value="'+detail6+'" disabled></input><input id="cart6" value="'+cart6+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send6()">comfirm</ons-button></ons-list-item></ons-card>');
                         }
                         if(amountไข่เจียวลาบ != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >ไข่เจียวลาบ: <input id="amountTotal7" value="'+amountไข่เจียวลาบ+'" disabled></input> จๅน</div><input id="detail7" value="'+detail7+'" disabled></input><input id="cart7" value="'+cart7+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send7()">comfirm</ons-button></ons-list-item></ons-card>');
                         }
                          if(amountไก่กรอบลาบแซ่บ != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >ไก่กรอบลาบแซ่บ: <input id="amountTotal8" value="'+amountไก่กรอบลาบแซ่บ+'" disabled></input> จๅน</div><input id="detail8" value="'+detail8+'" disabled></input><input id="cart8" value="'+cart8+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send8()">comfirm</ons-button></ons-list-item></ons-card>');
                         }
                         if(amountน้ำใบเตย != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >น้ำใบเตย: <input id="amountTotal9" value="'+amountน้ำใบเตย+'" disabled></input> จๅน</div><input id="detail9" value="'+detail9+'" disabled></input><input id="cart9" value="'+cart9+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send9()">comfirm</ons-button></ons-list-item></ons-card>');
                         }
                         if(amountน้ำฝรั่ง != 0){
                            $("#addComfirm").append('<ons-card class="post"><ons-list-item class="post_title"><div class="post-caption" >น้ำฝรั่ง: <input id="amountTotal10" value="'+amountน้ำฝรั่ง+'" disabled></input> จๅน</div><input id="detail10" value="'+detail10+'" disabled></input><input id="cart10" value ="'+cart10+'" disabled></input><ons-button class="corner-button" modifier="quiet" onclick="send10()">comfirm</ons-button></ons-list-item></ons-card>');
                         }               
                    ...
                    $.ajax({
                        ...
                        function findDataTable(dataQueue){
                           ...
                           for(var j = 0 ; j<dataQueue.length ; j++){
                            ...
                            $('#amountFood31').append("Amount: " +data[i].Amount +" Detail: "+data[i].Detail +" Table: "+dataQueue[j].Name);
                            return false;
                                }
                           }
