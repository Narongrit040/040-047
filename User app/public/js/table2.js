...
$(function() {
    ...
    function findData(dataType){
        ...
        $('#pinFirst').append(dataType[2].Name);
...
var dataQueueId = [];
 ...
 // $('#pinThird').append('<a href="edit.html?id='+dataQueueId[2]+'>');
...
function send(){
    $.ajax({
        ...
        window.location.href = 'FoodMenu.html?id='+dataType[2].IdQueue;
    });
