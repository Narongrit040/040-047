...
var numroOrder = 1 ; 
                        ...
                        if(amountต้มยำกุ้ง != 0){
                            ...
                            $("#addComfirm").append('<div class="card" style="color:black; font-size : 25px;" > <div class="row"> <div class="col">ต้มยำกุ้ง</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" type="text" id="amountTotal1" value="'+amountต้มยำกุ้ง+'" disabled></input> จาน<br>  Detail: <input  style="color: red;background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail1" value="'+detail1+'" disabled><input hidden id="cart1" value="'+cart1+'" disabled></input> <br><button   class="btn btn-danger float-right"  style= " font-size : 25px;"   class="btn btn-danger"   onclick="send1()">comfirm</button></center></div></div>');
                            numroOrder++;
                         }
                        if(amountต้มเส้นตีนไก่ != 0){
                            $("#addComfirm").append('<div class="card" style="color:black; font-size : 25px;" > <div class="row"> <div class="col">ต้มยำกุ้ง</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวนต้มเส้นตีนไก่: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" type="text" id="amountTotal3" value="'+amountต้มเส้นตีนไก่+'" disabled></input> จาน<br> Detail: <input  style="color: red;background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id = "detail3" value="'+detail3+'" disabled><input hidden id="cart3" value="'+cart3+'" disabled></input><br> <button   class="btn btn-danger float-right" style="  font-size : 25px;"   class="btn btn-danger"  onclick="send3()">comfirm</button></center></div></div>');
                            numroOrder++;
                        }
                          if(amountผัดแกงเขียวหวานปลาแซลมอน != 0){
                            $("#addComfirm").append('<div class="card" style="color:black; font-size : 25px;"> <div class="row"> <div class="col">ผัดแกงเขียวหวานปลาแซลมอน</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" id="amountTotal4" value="'+amountผัดแกงเขียวหวานปลาแซลมอน+'" disabled></input> จาน   <br> Detail:  <input  style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail4" value="'+detail4+'" disabled><input hidden id="cart4" value="'+cart4+'" disabled></input> <br><button   class="btn btn-danger float-right"  style= " font-size : 25px;"   class="btn btn-danger"   onclick="send4()">comfirm</button></center></div> </div>');  
                            numroOrder++;
                        }
                         if(amountผัดผักโสภณลูกชิ้นกุ้ง != 0){
                            $("#addComfirm").append('<div class="card" style="color:black; font-size : 25px;"> <div class="row"> <div class="col">ผัดผักโสภณลูกชิ้นกุ้ง</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" id="amountTotal5" value="'+amountผัดผักโสภณลูกชิ้นกุ้ง+'" disabled> </input> จาน<br> Detail:  <input  style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail5" value="'+detail5+'" disabled><input hidden id="cart5" value="'+cart5+'" disabled></input> <br><button  class="btn btn-danger float-right" style=" font-size : 25px;"   class="btn btn-danger"   onclick="send5()">comfirm</button></center></div></div>');
                            numroOrder++;
                        }
                          if(amountฉู่ฉี่ปลาเนื้ออ่อน != 0){
                            $("#addComfirm").append('<div class="card" style="color:black; font-size : 25px;"> <div class="row"> <div class="col">ฉู่ฉี่ปลาเนื้ออ่อน</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" id="amountTotal6" value="'+amountฉู่ฉี่ปลาเนื้ออ่อน+'" disabled></input> จาน<br> Detail:  <input  style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail6" value="'+detail6+'" disabled><input hidden id="cart6" value="'+cart6+'" disabled></input> <br><button   class="btn btn-danger float-right"  style="  font-size : 25px;"   class="btn btn-danger"  onclick="send6()">comfirm</button></center></div> </div>');
                            numroOrder++;
                        }
                         if(amountไข่เจียวลาบ != 0){
                            $("#addComfirm").append('<div class="card"style="color:black; font-size : 25px;"> <div class="row"> <div class="col">ไข่เจียวลาบ</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" id="amountTotal7" value="'+amountไข่เจียวลาบ+'" disabled></input> จาน<br> Detail:  <input  style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail7" value="'+detail7+'" disabled><input hidden id="cart7" value="'+cart7+'" disabled></input><br> <button class="btn btn-danger float-right" style="  font-size : 25px;"    class="btn btn-danger"   onclick="send7()">comfirm</button></center></div> </div>');
                            numroOrder++;
                        }
                          if(amountไก่กรอบลาบแซ่บ != 0){
                            $("#addComfirm").append('<div class="card"style="color:black; font-size : 25px;"> <div class="row"> <div class="col">ไก่กรอบลาบแซ่บ</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" id="amountTotal8" value="'+amountไก่กรอบลาบแซ่บ+'" disabled></input> จาน<br> Detail:  <input  style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail8" value="'+detail8+'" disabled><input hidden id="cart8" value="'+cart8+'" disabled></input><br>  <button  class="btn btn-danger float-right"  style="  font-size : 25px;"  class="btn btn-danger"   onclick="send8()">comfirm</button></center></div> </div>');
                            numroOrder++;
                        }
                         if(amountน้ำใบเตย != 0){
                            $("#addComfirm").append('<div class="card"style="color:black; font-size : 25px;"> <div class="row"> <div class="col">น้ำใบเตย</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" id="amountTotal9" value="'+amountน้ำใบเตย+'" disabled></input> จาน <br>Detail:  <input  style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail9" value="'+detail9+'" disabled><input hidden id="cart9" value="'+cart9+'" disabled></input> <br> <button   class="btn btn-danger float-right"  style="  font-size : 25px;"  class="btn btn-danger"    onclick="send9()">comfirm</button></center></div></div>');
                            numroOrder++;
                        }
                         if(amountน้ำฝรั่ง != 0){ 
                            $("#addComfirm").append('<div class="card"style="color:black; font-size : 25px;"> <div class="row"> <div class="col">น้ำฝรั่ง</div><div class="col"><p class=" text-right text-white"><kbd>'+numroOrder+'</kbd> </p></div></div>จำนวน: <input style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" size="1" id="amountTotal10" value="'+amountน้ำฝรั่ง+'" disabled></input> จาน<br> Detail:  <input  style="color: red; background-color:rgba(0, 0, 0, 0.0);border-color:rgba(0, 0, 0, 0.0);font-size:24px;" id="detail10" value="'+detail10+'" disabled><input hidden id="cart10" value ="'+cart10+'" disabled></input> <br> <button  class="btn btn-danger float-right" style="  font-size : 25px;"   class="btn btn-danger"    onclick="send10()">comfirm</button></center></div></div>');
                            numroOrder++;
                        }               
